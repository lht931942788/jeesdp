 ...
 * ```
 *
 * @param {{container: Vue | Element | Vue[] | Element[], keyboard: {bindTo: Window}, additionalModules: [*], moddleExtensions: {wf: *}}} [options] configuration options to pass to the viewer
