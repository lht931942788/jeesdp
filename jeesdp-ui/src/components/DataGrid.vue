    ...
    >
      ...
      >
        ...
        >
          ...
          <template
              v-if="'timePicker,datePicker'.indexOf(field.fieldType) > -1"
              #default="scope"
          >
          ...
          <template
              v-else-if="'select,radio,checkbox'.indexOf(field.fieldType) > -1"
              #default="scope"
          >
